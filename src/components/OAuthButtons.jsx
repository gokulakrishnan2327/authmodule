...
const OAuthButtons = ({ mode = 'login' }) => {
  ...
  return (
    <div className="flex space-x-4 justify-start">
      {/* Google button with original multi-colored logo */}
      <button 
        onClick={handleGoogleAuth}
        className="w-40 h-12 rounded-md border border-gray-350 px-4 py-2 flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors font-sans">
