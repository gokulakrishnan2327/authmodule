            ...
            {!loading && !error && (
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="mt-8">
                  ...
                  >
                    <span className="mx-4 font-large">Send reset link</span>
                  </Button>
                </div>
                
                {/* Increased top margin for back to sign in */}
                <div className="mt-8 text-left">
                  <p className="font-roboto text-sm tracking-wider text-[#64646D] leading-6">
                    Back to{' '}
                    <Link 
                      to="/auth/login" 
